...
sp_points4<-subset(sp_points,sp_points$row_num>3000000 & sp_points$row_num<=4000000)
sp_points5<-subset(sp_points,sp_points$row_num>4000000)

write_xlsx(sp_points1,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas40_1.xlsx")
write_xlsx(sp_points2,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas40_2.xlsx")
write_xlsx(sp_points3,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas40_3.xlsx")
write_xlsx(sp_points4,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas40_4.xlsx")
write_xlsx(sp_points5,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas40_5.xlsx")
...
sp_points_outside<- subset(sp_points, state_name=="character(0)" & month==1)
...
###Repeat the whole thing for years 40-80
ncpath <- "\\\\net.nefsc.noaa.gov/aharris/DisMap data/"
...
write_xlsx(sp_points1,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas80_1.xlsx")
write_xlsx(sp_points2,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas80_2.xlsx")
write_xlsx(sp_points3,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas80_3.xlsx")
write_xlsx(sp_points4,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas80_4.xlsx")
write_xlsx(sp_points5,"\\\\net.nefsc.noaa.gov/aharris/DisMap data/bottom_temp_deltas80_5.xlsx")
...
#Check to see if bt_tmps that are not associated with a state indeed fall outside the state biomass access areas
sp_points_outside<- subset(sp_points, state_name=="character(0)" & month==481)

dat$row_num<- seq.int(nrow(dat)) 
dat_merge<- subset(dat, select=c("row_num", "lat", "lon"))
sp_points_outside = merge(sp_points_outside, dat_merge, by = "row_num", all.y=FALSE)

sp_points_inside<- subset(sp_points, state_name!="character(0)" & month==481)
sp_points_inside = merge(sp_points_inside, dat_merge, by = "row_num", all.y=FALSE)
